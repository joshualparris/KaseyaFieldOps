  ...
  sources: [
    {
      ...
      evidenceSummary: "SIRIS local virtualization.", evidenceType: "kaseya-product"
    },
    {
      ...
      verifiedAt: "2026-08-20T00:00:00Z",
      evidenceSummary: "Screenshot verification and ransomware checks.", evidenceType: "kaseya-product"
    },
    {
      id: "src-bcdr-hybrid",
      ...
      verifiedAt: "2026-08-20T00:00:00Z",
      evidenceSummary: "ALTO hybrid virtualization capabilities.", evidenceType: "kaseya-product"
    },
    {
      id: "src-bcdr-bmr",
      ...
      verifiedAt: "2026-08-20T00:00:00Z",
      evidenceSummary: "Bare-metal/image restore.", evidenceType: "kaseya-product"
    }
  ]
};
...
export const scenarios: Scenario[] = [
  {
    ...
    steps: {
      'step-1': {
        id: 'step-1', sourceRefs: ['src-bcdr-local-virt'],
      ...
      'step-2': {
        id: 'step-2', sourceRefs: ['src-bcdr-local-virt'],
      ...
      'step-3': {
        id: 'step-3', sourceRefs: ['src-bcdr-local-virt'],
...
export const cards: Flashcard[] = [
  { id: 'fc-backup-1', sourceRefs: ['src-bcdr-local-virt'], moduleId: 'datto-backup', question: 'What is a "Recovery Point"?', answer: 'A specific snapshot in time of a protected system that can be used for restoration.' },
  { id: 'fc-backup-2', sourceRefs: ['src-bcdr-local-virt'], moduleId: 'datto-backup', question: 'What is the primary difference between a SIRIS and an ALTO appliance?', answer: 'SIRIS supports Local Virtualization (spinning up VMs directly on the appliance hardware). ALTO relies on Hybrid Virtualization (spinning VMs up in the Datto Cloud).' },
  { id: 'fc-backup-3', sourceRefs: ['src-bcdr-local-virt'], moduleId: 'datto-backup', question: 'What is Inverse Chain Technology?', answer: 'Datto\'s backup method where every incremental snapshot is stored in a fully constructed state, eliminating the risk of a broken backup chain.' },
  { id: 'fc-backup-4', sourceRefs: ['src-bcdr-local-virt'], moduleId: 'datto-backup', question: 'What does "Screenshot Verification" do?', answer: 'It automatically boots the backup snapshot as a hidden virtual machine, takes a picture of the OS login screen, and alerts if it fails to boot.' },
  { id: 'fc-backup-5', sourceRefs: ['src-bcdr-local-virt'], moduleId: 'datto-backup', question: 'When would you use a Bare Metal Restore (BMR)?', answer: 'When you need to restore an entire operating system, applications, and data onto completely new or wiped physical hardware.' }
];

...
export const module: AppModule = {
  ...
  sources: [
    {
      id: "src-inky-graphus-disable",
      title: "Disable Graphus",
      url: "https://help.inky.com/articles/8548579-disable-graphus-prior-to-inky-install",
      verifiedAt: "2026-08-20T00:00:00Z",
      evidenceSummary: "Graphus must be disabled before INKY install.", evidenceType: "kaseya-product"
    },
    {
      id: "src-inky-migration",
      title: "Migrating to INKY",
      url: "https://help.inky.com/en/help/collections/4578717-graphus-or-saas-defense-to-inky",
      verifiedAt: "2026-08-20T00:00:00Z",
      evidenceSummary: "Migration paths from Graphus/SaaS Defense to INKY.", evidenceType: "kaseya-product"
    },
    {
      id: "src-inky-k365",
      title: "Adding INKY in K365",
      url: "https://help.one.kaseya.com/help/Content/1_Configuration/k365-add-inky.htm",
      verifiedAt: "2026-08-20T00:00:00Z",
      evidenceSummary: "Deploying INKY via KaseyaOne SSO.", evidenceType: "kaseya-product"
    }
  ]
};
...
export const scenarios: Scenario[] = [
  {
    ...
    steps: {
      'step-1': {
        id: 'step-1', sourceRefs: ['src-inky-migration'],
      ...
      'step-2': {
        id: 'step-2', sourceRefs: ['src-inky-migration'],
  ...
  },
  {
    ...
    steps: {
      ...
      'step-3': {
        id: 'step-3', sourceRefs: ['src-inky-migration'],
...
export const cards: Flashcard[] = [
  { id: 'fc-inky-1', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What does a Yellow INKY banner indicate?', answer: 'Caution. It highlights something unusual, like a first-time sender or external sender, but not necessarily malicious.' },
  { id: 'fc-inky-2', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What does a Red INKY banner indicate?', answer: 'Danger. The email is highly likely to be malicious, phishing, or a scam. Links and attachments are often disabled.' },
  { id: 'fc-inky-3', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What does a Gray INKY banner indicate?', answer: 'Safe/Informational. It usually denotes an external sender that has been established as safe.' },
  { id: 'fc-inky-4', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'How does INKY integrate with Microsoft 365?', answer: 'Via API and mail flow rules (connectors). It does not require changing MX records.' },
  { id: 'fc-inky-5', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What is INKY\'s "Phish Fence"?', answer: 'The core engine that analyzes emails for phishing, impersonation, and malware using machine learning.' },
  { id: 'fc-inky-6', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'Can users report emails via the INKY banner?', answer: 'Yes, the banner often includes a "Report This Email" link which allows users to provide feedback directly to INKY and the IT team.' },
  { id: 'fc-inky-7', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What is "Passive Mode" in INKY?', answer: 'A monitoring state where INKY analyzes mail but does not insert banners or block emails, used for baselining.' },
  { id: 'fc-inky-8', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'Does INKY scan internal emails (user-to-user)?', answer: 'Yes, if configured to do so, which is critical for catching lateral movement from a compromised internal account.' },
  { id: 'fc-inky-9', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'How do you remediate a false positive in INKY?', answer: 'Use the INKY dashboard to search for the message and reclassify it as "Safe", which updates the machine learning model.' },
  { id: 'fc-inky-10', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What is "Brand Impersonation"?', answer: 'When an attacker spoofs a well-known company (like Microsoft or UPS). INKY uses computer vision to detect fake logos and layouts.' },
  { id: 'fc-inky-11', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What is a "Lookalike Domain"?', answer: 'A domain registered to look like the target company (e.g., rnicrosoft.com instead of microsoft.com), often flagged by INKY.' },
  { id: 'fc-inky-12', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'If you whitelist a sender in INKY, what happens to their emails?', answer: 'They bypass certain security checks and banners, which is why whitelisting should be done sparingly and carefully.' },
  { id: 'fc-inky-13', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'Can INKY rewrite URLs to protect users?', answer: 'Yes, similar to Safe Links, INKY can rewrite URLs so that when a user clicks, the destination is analyzed in real-time.' },
  { id: 'fc-inky-14', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'Does INKY protect against Business Email Compromise (BEC)?', answer: 'Yes, it is explicitly designed to catch text-only BEC attacks (like fake invoice requests) by analyzing sender behavior and stylometry.' },
  { id: 'fc-inky-15', sourceRefs: ['src-inky-migration'], moduleId: 'inky', question: 'What happens when INKY quarantines an email?', answer: 'The email is moved to a quarantine folder (either in M365 or INKY\'s vault) and is not delivered to the user\'s inbox.' }
];
